...
/*   Updated: 2022/10/25 17:42:18 by cpeset-c         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_lltoa(t_ll nbr, int base, char *str);
char	*ft_ulltoa(t_ull nbr, int base, char *str);
int		ft_nbrlen(t_ll nbr);
t_unt	ft_nbrlen_base(t_ll nbr, int base);
