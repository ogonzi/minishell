...
#    Updated: 2022/10/21 16:24:02 by ogonzale         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
MAND_DIR	:= mand/
MAND_FILES	:= minishell signals split_cmd_line ft_split_mod split_words split_utils free exec get_exec_path utils 
